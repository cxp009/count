...
public class ListAdapter<costList> extends BaseAdapter {
    List<costList> mList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //绑定
        tv_title.setText((Integer) mList.get(position));

        tv_date.setText((Integer) mList.get(position));
        tv_money.setText((Integer) mList.get(position));
        return view;
